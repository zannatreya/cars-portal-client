      ...
      <div>
        <section>
          <div className="text-center mx-auto lg:shadow-xl rounded-xl p-10 m-10 border">
            <h1 className="text-lg lg:text-xl font-semibold text-primary uppercase mb-5">
              Every field should be filled to import a new part
            </h1>
              ...
              <div className="flex flex-col lg:flex-row gap-5">
                <div className="form-control w-full">
                  ...
                  <label className="label">
                    {errors.name?.type === "required" && (
                      <span className="label-text-alt text-pink-600">
                        {errors.name.message}
                      </span>
                    )}
                  </label>
                ...
                <div className="form-control w-full">
                  ...
                  <input
                    ...
                    className={`input input-bordered pt-1  ${
                      errors.image && "border-pink-600"
                    }`}
                  />
                  <label className="label">
              ...
              <div className="flex flex-col lg:flex-row gap-5">
                ...
                <div className="form-control w-full">
                  ...
                  <input
                    ...
                    className={`input input-bordered  ${
                      errors.available && "border-pink-600"
                    }`}
                  />
                  <label className="label">
                ...
                <div className="form-control w-full">
                  ...
                  <input
                    ...
                    className={`input input-bordered  ${
                      errors.minOrder && "border-pink-600"
                    }`}
                  />
                  <label className="label">
              ...
              <div className="form-control w-full">
                ...
                <textarea
                  ...
                  className={`input input-bordered h-32  ${
                    errors.overview && "border-pink-600"
                  }`}
                />
                <label className="label">
