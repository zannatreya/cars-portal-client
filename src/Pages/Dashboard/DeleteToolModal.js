    ...
    fetch(` https://car-parts-server-six.vercel.app/part/${id}`, {
      ...
      .then((data) => {
        ...
        if (data.deletedCount) {
          ...
          toast.success(`${deletingTool.name} is deleted`);
        }
      });
  };
      ...
      <div className="modal modal-bottom sm:modal-middle">
        <div className="modal-box relative">
          ...
          <h3 className="font-semibold lg:text-lg text-secondary">
            ...
            <span className="font-bold">{deletingTool.name}</span> ?
          </h3>
          <p className="py-4">
            Deleted parts will be removed from your website and you won't see
            this Parts anymore.
          </p>
