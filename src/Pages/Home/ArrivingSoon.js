...
import TeslaCar1 from "../../assets/images/tesla.jpg";
      ...
      <div className="grid lg:grid-cols-2 gap-10">
        <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
          <div className="max-w-xl mb-6">
            <h2 className="max-w-lg mb-6 text-3xl font-bold font-sans tracking-tight sm:text-4xl sm:leading-none">
              Let's Book Our
            ...
            <p className="text-base text-gray-600 md:text-lg">
              Tesla Brand's parts are manufacturing now. Within 1 week we will
              announce our publish date. Let's book your position now to get the
              best.
            </p>
          </div>
          <div>
