...
import SecondaryOutlineButton from "../Shared/SecondaryOutlineButton";
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-2xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              >
                We are manufacturing car parts since 1998 and serving them with
                best quality and a long time warranty.
              </p>
              <p
