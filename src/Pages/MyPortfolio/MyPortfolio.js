...
const MyPortfolio = () => {
  const projects = [
    ...
    },
    {
      ...
      name: "Travel Portal",
      description:
        "Travel Portal is a website for passionate travelers. Who want to travel all over the world.",
      img: "https://i.ibb.co/JBPvkg1/Traveeel.png",
      link: "https://travel-portal-009.netlify.app/",
    },
    // {
    //   id: 3,
    //   name: "Coin Kinbo",
    //   description:
    //     "This is a coin buying website where user can buy coin whatever they want",
        ...
        <article className="py-20" id="project">
          <div className="text-center">
            ...
            <p className="mt-4 text-base text-gray-600 md:text-lg">
              Here you will get the overview of latest{" "}
              <br className="hidden md:block" /> projects done by me.
            </p>
          </div>
          <section className="my-10 grid grid-cols-1 lg:grid-cols-3 gap-5">
            {projects.map((project) => (
              <div
                key={project.id}
                className="card max-w-xl bg-white border border-primary shadow-xl"
              >
