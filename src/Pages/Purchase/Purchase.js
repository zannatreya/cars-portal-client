...
const Purchase = () => {
  ...
  return (
    <section className="px-4 py-4 lg:px-20 my-10">
      <div className="flex flex-col-reverse md:flex-row gap-5">
        ...
        <div>
          <h1 className="text-xl lg:text-2xl font-semibold text-primary-focus mb-8 text-center uppercase">
            Fill this form to place order
          </h1>
          <form onSubmit={handleSubmit(onSubmit)}>
            {/* product information  */}
            <p className="before:border before:border-primary font-semibold uppercase tracking-wider my-3">
              Product Information
            </p>
              ...
              <div className="form-control mb-5 w-1/2 md:w-full ml-10">
                ...
                <input
                  ...
                  className={`input input-bordered  ${
                    errors.quantity && "border-pink-600"
                  }`}
                />
                <label className="label">
