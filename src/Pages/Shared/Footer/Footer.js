      ...
      <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-sm">
                We are serving Car Parts proudly since 1992 with great consumer
                reviews.
              </p>
              <p className="mt-4 text-sm">
                The Carts is a Car Parts Manufacturer where you will find the
                world's best parts of your car.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
            ...
            <div>
              <p className="font-semibold tracking-wide ">Cars</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <Link
                    to="/"
        ...
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-deep-purple-accent-200 sm:flex-row">
          <p className="text-sm text-gray-100">
            © Copyright 2023 Cars Portal. All rights reserved.
          </p>
